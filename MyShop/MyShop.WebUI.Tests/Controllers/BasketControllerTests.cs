...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "atish.chuckooa@hangarww.com", ZipCode = "90210" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("atish.chuckooa@hangarww.com", "Forms"), null);
